...
class MyFormComponent extends Component {
  constructor(props) {
    ...
    if (this.props.match.params.id) {
      ...
      this.state = {
        key: uid(), name: "", date: '', exersise: '', reps: '', weight: '', distance:'', time: '', date: '',
      };
    }
  }
  ...
  handle_submit(event) {
    ...
    this.props.onSubmit({key: uid(), name: this.state.name, reps: this.state.reps, date: this.state.date.toString(), exersise: this.state.exersise, weight: this.state.weight, distance: this.state.distance, time: this.state.time, clicked: false});
